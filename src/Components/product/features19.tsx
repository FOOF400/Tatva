...
interface Features19Props {
  ...
  Features19.defaultProps = {
    ...
    feature1Description: "Our compost boosts the presence of beneficial microbes in the soil, which aids in the natural breakdown of organic matter and nutrient cycling.",
  };
